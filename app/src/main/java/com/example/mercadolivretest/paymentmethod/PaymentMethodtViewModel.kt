...
open class PaymentMethodtViewModel(context: Application, private val payMarketRepository: PayMarketRepository) : AndroidViewModel(context) {
    ...
    fun loadPaymentMethod(callback: PayMarketDataSource.PaymentMethodCallback) {
        payMarketRepository.getPaymentMethod(object : PayMarketDataSource.PaymentMethodCallback {
